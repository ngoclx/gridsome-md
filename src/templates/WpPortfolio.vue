<template>
  <Layout :path="$page.wpPortfolio.path" :ptitle="$page.wpPortfolio.title | decodeSpecialChars" :pageAncestors="[{ title: 'case studies', link: 'https://marameodesign.com/case-studies' }]">
